  ...
  export default function FormField (props) {
    ...
    return <div className='fill label-input-field'>
      ...
      <input defaultValue="" type="text" id={props.name} name={props.name} placeholder={props.placeholder} value={props.value} required={props.required} onChange={props.onChange} />
